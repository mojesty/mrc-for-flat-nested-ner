...
def load_data(config):
    ...
    train_features = convert_examples_to_features(train_examples, tokenizer, label_list, config.max_seq_length,
    ...
    train_data = TensorDataset(train_input_ids, train_input_mask, train_segment_ids, train_start_pos, train_end_pos,
                               train_ner_cate)
    ...
    test_data = TensorDataset(test_input_ids, test_input_mask, test_segment_ids, test_start_pos, test_end_pos,
                              test_ner_cate)
...
def eval_checkpoint(model_object, eval_dataloader, config,
    ...
    eval_accuracy, eval_precision, eval_recall, eval_f1 = query_ner_compute_performance(start_pred_lst, end_pred_lst,
                                                                                        start_gold_lst, end_gold_lst,
